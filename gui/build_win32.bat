...
@set INCLUDES=/Iimgui /Iimgui\backends /Iimgui\libs\glfw\include
@set SOURCES=src/main.cpp imgui\backends\imgui_impl_glfw.cpp imgui\backends\imgui_impl_opengl3.cpp imgui\imgui*.cpp
@set LIBS=/LIBPATH:imgui\libs\glfw\lib-vc2010-32 glfw3.lib opengl32.lib gdi32.lib shell32.lib
mkdir %OUT_DIR%
